...
mod tests {
    ...
    use crate::{
        georaster::{
            testutils::{NOD, *},
            DenseGeoRaster, GeoRaster, GeoRasterCreation, RasterNum,
        },
        GeoReference,
    };
    ...
    #[test]
    fn test_add_raster_with_nodata<T: RasterNum<T>, R: GeoRaster<T> + GeoRasterCreation<T>>()
    where
    ...
    #[test]
    fn test_add_scalar_with_nodata<T: RasterNum<T>, R: GeoRaster<T> + GeoRasterCreation<T>>() {
        let raster1 = R::new(META, create_vec(&[NOD, 2.0, 2.0, 3.0, NOD, 3.0, 1.0, 1.0, 0.0]));
    ...
    #[test]
    fn test_subtract_raster_with_nodata<T: RasterNum<T>, R: GeoRaster<T> + GeoRasterCreation<T>>()
    where
    ...
    #[test]
    fn test_subtract_scalar_with_nodata<T: RasterNum<T>, R: GeoRaster<T> + GeoRasterCreation<T>>() {
    ...
    #[test]
    fn test_multiply_raster_with_nodata<T: RasterNum<T>, R: GeoRaster<T> + GeoRasterCreation<T>>()
    where
    ...
    #[test]
    fn test_multiply_scalar_with_nodata<T: RasterNum<T>, R: GeoRaster<T> + GeoRasterCreation<T>>() {
        let raster1 = R::new(META, create_vec(&[NOD, 2.0, 2.0, 3.0, NOD, 3.0, 1.0, 1.0, 0.0]));
    ...
    #[test]
    fn test_divide_raster_with_nodata<T: RasterNum<T>, R: GeoRaster<T> + GeoRasterCreation<T>>()
    where
    ...
    #[test]
    fn test_divide_scalar_with_nodata<T: RasterNum<T>, R: GeoRaster<T> + GeoRasterCreation<T>>() {
    ...
    #[test]
    fn test_sum<T: RasterNum<T>, R: GeoRaster<T> + GeoRasterCreation<T>>() {
